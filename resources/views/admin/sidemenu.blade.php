<div class="flex flex-col w-52 h-max items-center border-r-2 border-blue-300">
 <div class="rounded-full border-4 border-blue-300 w-fit h-fit mt-10 px-5 py-4 text-xl font-bold text-blue-500">FQ</div>
<div class="flex justify-center mt-5 mb-10"> 
 <ul class="flex flex-col space-y-5 items-center text-blue-500 font-bold text-xl">
  <a href="{{url('/admin')}}"><li class="hover:underline cursor-pointer">Home</li></a>
  <a href="{{url('/admin/view/orders')}}"><li class="hover:underline cursor-pointer">Orders</li></a>
