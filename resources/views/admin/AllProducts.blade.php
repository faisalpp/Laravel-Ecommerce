 ...
 <div class="flex flex-col w-4/5 ml-5">
  <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
    <div class="py-4 inline-block min-w-full sm:px-6 lg:px-8">
      <div class="flex justify-end w-full mb-2"><a href="{{url('/admin/view/form/product')}}" class="bg-blue-500 font-bold text-white px-4 py-2 rounded-lg">Add Product</a></div>
