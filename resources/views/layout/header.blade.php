...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
 ...
 <div class="flex space-x-5 items-center justify-center py-3 font-bold text-lg w-full h-fit">
  ...
  <div class="flex items-center justify-center space-x-10 text-lg bg-blue-500 text-white font-bold w-full h-fit">
